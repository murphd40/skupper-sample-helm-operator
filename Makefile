...
# example.com/skupper-sample-helm-operator-bundle:$VERSION and example.com/skupper-sample-helm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= example.com/skupper-sample-helm-operator
